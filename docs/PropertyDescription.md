The [[Properties|Property]] of an Item are defined in its [[ItemDescription]] in a PropertyDescription outcome. Each Property description defines the following:
