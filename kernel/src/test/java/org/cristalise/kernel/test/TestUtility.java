...
public interface TestUtility {
    ...
    /**
     * This logger name is made unusual to avoid the problem when this interface is used in enums.
     * When all the values of such enum is statically imported, the log variable will be imported as well. 
     * This will somehow supersede the log variable declared of the importing class.
     */
    final static Logger tuLogger = LoggerFactory.getLogger(SystemPropertyOperations.class);
     ...
     */
    default boolean compareXML(String expected, String actual)  {
        ...
        if (diffIdentical.hasDifferences()) {
            tuLogger.warn(diffIdentical.toString());
            tuLogger.info("expected:\n{}", expected);
            tuLogger.info("actual:\n{}", actual);
        }
