 ...
 * 
 */
public class Login extends PredefinedStep {

    public static final String description = "Records the Login event in the system";
    ...
    {
        Logger.msg(1, "Login.request() - Starting.");
