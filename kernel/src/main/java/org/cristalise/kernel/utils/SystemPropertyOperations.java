...
public interface SystemPropertyOperations {
    ...
    default String getString(String defaultOverwrite, Object... nameArgs) {
        ...
        if (enumLogger.isTraceEnabled()) enumLogger.trace("getString() - {} => {}", getActualName(nameArgs), actualValue);
    ...
    default Integer getInteger(Integer defaultOverwrite, Object... args) {
        ...
        if (enumLogger.isTraceEnabled()) enumLogger.trace("getInteger() - {} => {}", getActualName(args), actualValue);
    ...
    default Boolean getBoolean(Boolean defaultOverwrite, Object... args) {
        ...
        if (enumLogger.isTraceEnabled()) enumLogger.trace("getBoolean() - {} => {}", getActualName(args), actualValue);
    ...
    default Object getInstance(Object... nameArgs) throws ReflectiveOperationException {
        ...
        if (enumLogger.isTraceEnabled()) enumLogger.trace("getInstance() - {} => {}", getActualName(nameArgs), actualValue);
