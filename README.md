...
## Release process for version 6.0.0
1. **Steps on GitHub**
   1. review issues listed in the GitHub Release
   1. move all open GitHub issues to a new Release (e.g. from 5.9.x to 6.0.0)
      - make sure all remaining/closed issues have at least the bug/enhancement flags required for the release summary
1. **Steps on the dev machine**
   ...
   1. `mvn clean install` - for sanity check, it will be executed in travis anyway
   1. `git push`
1. **Steps on GitHub**
