 ...
 *
 */
class SchemaBuilderExpressionSpecs extends Specification implements CristalTestSetup {

    def setup()   { Gateway.init(null) }
    def cleanup() { cristalCleanup() }

    def 'Field can specify expression in groovy'() {
        when:
                       ...
                       <xs:element name='DateOfBirth' type='xs:date' minOccurs='1' maxOccurs='1'>
                         <xs:annotation>
                           <xs:appinfo>
                             <dynamicForms>
                               <additional>
                                 <updateScriptRef>Patient_DetailsComputeAgeUpdateExpression:10</updateScriptRef>
                               </additional>
                             </dynamicForms>
                           </xs:appinfo>
                         </xs:annotation>
