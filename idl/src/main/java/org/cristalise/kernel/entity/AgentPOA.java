...
/**
* org/cristalise/kernel/entity/AgentPOA.java .
...
public abstract class AgentPOA extends org.omg.PortableServer.Servant
 implements org.cristalise.kernel.entity.AgentOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("refreshJobList", new java.lang.Integer (0));
    _methods.put ("addRole", new java.lang.Integer (1));
    _methods.put ("removeRole", new java.lang.Integer (2));
    _methods.put ("getSystemKey", new java.lang.Integer (3));
    _methods.put ("initialise", new java.lang.Integer (4));
    _methods.put ("queryData", new java.lang.Integer (5));
    _methods.put ("requestAction", new java.lang.Integer (6));
    _methods.put ("delegatedAction", new java.lang.Integer (7));
    _methods.put ("requestActionWithScript", new java.lang.Integer (8));
    _methods.put ("queryLifeCycle", new java.lang.Integer (9));
  }
  ...
  /** Supplies the new set of jobs for the given item and activity. The Agent should replace all existing jobs for that activity 
            ...
            **/
       case 0:  // entity/Agent/refreshJobList
       {
         org.cristalise.kernel.common.SystemKey itemKey = org.cristalise.kernel.common.SystemKeyHelper.read (in);
         String stepPath = in.read_string ();
         String newJobs = in.read_string ();
         this.refreshJobList (itemKey, stepPath, newJobs);
         out = $rh.createReply();
         break;
       }
  ...
  /** Add this Agent to the given role
       ...
       case 1:  // entity/Agent/addRole
       {
         ...
         } catch (org.cristalise.kernel.common.CannotManageException $ex) {
           out = $rh.createExceptionReply ();
           org.cristalise.kernel.common.CannotManageExceptionHelper.write (out, $ex);
         }
         break;
       }
  ...
  /** Remove this Agent from the given role
  		  ...
  		  * @throws CannotManageException when an error occurs writing the data to LDAP
  		  **/
       case 2:  // entity/Agent/removeRole
       {
         try {
           String roleName = in.read_string ();
  ...
  /**
          ...
          **/
       case 3:  // entity/Item/getSystemKey
       {
  ...
  /**
          ...
          **/
       case 6:  // entity/Item/requestAction
       {
         try {
           org.cristalise.kernel.common.SystemKey agentKey = org.cristalise.kernel.common.SystemKeyHelper.read (in);
           String stepPath = in.read_string ();
       ...
       case 7:  // entity/Item/delegatedAction
       {
         try {
           org.cristalise.kernel.common.SystemKey agentKey = org.cristalise.kernel.common.SystemKeyHelper.read (in);
  ...
  /**
          ...
          * @throws ObjectAlreadyExistsException Not normally thrown, but reserved for PredefinedSteps to throw if they need to.
          **/
       case 8:  // entity/Item/requestActionWithScript
       {
         try {
           org.cristalise.kernel.common.SystemKey agentKey = org.cristalise.kernel.common.SystemKeyHelper.read (in);
           String stepPath = in.read_string ();
  ...
  /**
          ...
          **/
       case 9:  // entity/Item/queryLifeCycle
       {
         try {
           org.cristalise.kernel.common.SystemKey agentKey = org.cristalise.kernel.common.SystemKeyHelper.read (in);
  ...
  private static String[] __ids = {
    "IDL:org.cristalise.kernel/entity/Agent:1.0", 
