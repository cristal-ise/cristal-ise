...
/**************************************************************************
    ...
    **************************************************************************/
public class _AgentStub extends org.omg.CORBA.portable.ObjectImpl implements org.cristalise.kernel.entity.Agent
{
  ...
  public void refreshJobList (org.cristalise.kernel.common.SystemKey itemKey, String stepPath, String newJobs)
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("refreshJobList", true);
                org.cristalise.kernel.common.SystemKeyHelper.write ($out, itemKey);
                $out.write_string (stepPath);
                $out.write_string (newJobs);
                $in = _invoke ($out);
                return;
                ...
                refreshJobList (itemKey, stepPath, newJobs        );
            } finally {
                _releaseReply ($in);
            }
  } // refreshJobList
  ...
  public void addRole (String roleName) throws org.cristalise.kernel.common.ObjectNotFoundException, org.cristalise.kernel.common.CannotManageException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addRole", true);
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org.cristalise.kernel/common/ObjectNotFoundException:1.0"))
                    throw org.cristalise.kernel.common.ObjectNotFoundExceptionHelper.read ($in);
                else if (_id.equals ("IDL:org.cristalise.kernel/common/CannotManageException:1.0"))
                    throw org.cristalise.kernel.common.CannotManageExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                addRole (roleName        );
  ...
  public void removeRole (String roleName) throws org.cristalise.kernel.common.ObjectNotFoundException, org.cristalise.kernel.common.CannotManageException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("removeRole", true);
                $out.write_string (roleName);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public String requestAction (org.cristalise.kernel.common.SystemKey agentKey, String stepPath, int transitionID, String requestData, String fileName, byte[] attachment) throws org.cristalise.kernel.common.AccessRightsException, org.cristalise.kernel.common.InvalidTransitionException, org.cristalise.kernel.common.ObjectNotFoundException, org.cristalise.kernel.common.InvalidDataException, org.cristalise.kernel.common.PersistencyException, org.cristalise.kernel.common.ObjectAlreadyExistsException, org.cristalise.kernel.common.InvalidCollectionModification
  {
            ...
            try {
                ...
                return requestAction (agentKey, stepPath, transitionID, requestData, fileName, attachment        );
            } finally {
                _releaseReply ($in);
            }
  } // requestAction
  ...
  public String delegatedAction (org.cristalise.kernel.common.SystemKey agentKey, org.cristalise.kernel.common.SystemKey delegateAgentKey, String stepPath, int transitionID, String requestData, String fileName, byte[] attachment) throws org.cristalise.kernel.common.AccessRightsException, org.cristalise.kernel.common.InvalidTransitionException, org.cristalise.kernel.common.ObjectNotFoundException, org.cristalise.kernel.common.InvalidDataException, org.cristalise.kernel.common.PersistencyException, org.cristalise.kernel.common.ObjectAlreadyExistsException, org.cristalise.kernel.common.InvalidCollectionModification
  {
            ...
            try {
                ...
                return delegatedAction (agentKey, delegateAgentKey, stepPath, transitionID, requestData, fileName, attachment        );
            } finally {
                _releaseReply ($in);
            }
  } // delegatedAction
