...
public class ActivityViewer extends JPanel implements Runnable {
            ...
            if (desc.length() > chopDesc.length()) {
                ...
                descButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        JOptionPane.showMessageDialog(null, descScroll, "Activity Description",
            ...
            if (thisJob.hasOutcome()) {
                ...
                if (!schema.getName().equals("Errors") && outcomePanel == null) {
                    try {
                        ...
                        outcomeView.add(new JLabel("Schema not found: " + schema.getName() + " v"
                                + schema.getVersion()));
                    } catch (Exception ex) {
    ...
    public OutcomeHandler getOutcomeHandler(Job thisJob) throws ObjectNotFoundException,
            InvalidSchemaException, InvalidOutcomeException, InvalidDataException {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (returnVal == JFileChooser.APPROVE_OPTION) {
                        ...
                        log.info("ExecutionPane - Exporting outcome to file " + targetFile.getName());
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (returnVal == JFileChooser.APPROVE_OPTION) {
                        ...
                        log.info("ViewpointPane.actionPerformed() - Reading outcome from file "+ targetFile.getName());
        ...
        try {
            if (thisJob.hasOutcome())
                if (!thisJob.getSchema().getName().equals("Errors"))
                    ...
                    int result = JOptionPane.showConfirmDialog(this, errorBox, "Send Error",
