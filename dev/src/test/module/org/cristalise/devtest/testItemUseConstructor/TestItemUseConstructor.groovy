...
Schema('TestItemUseConstructor', 0) {
  struct(name:' TestItemUseConstructor', documentation: 'TestItemUseConstructor aggregated data', useSequence: true) {
    field(
      name: 'Name', 
      type: 'string'
    )
...
Schema('TestItemUseConstructor_Details', 0) {
  struct(name: 'TestItemUseConstructor_Details', useSequence: true) {
    field(
      name: 'Name', 
      type: 'string'
    )
