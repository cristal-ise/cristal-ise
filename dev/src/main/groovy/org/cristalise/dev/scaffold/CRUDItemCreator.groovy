...
class CRUDItemCreator extends StandardClient {
    ...
    public ItemProxy createItemWithUpdateAndCheck(Map record, String factoryPath) {
        ...
        if (!item) {
            ...
            forceUpate = true //this makes sure that the item is updated for the first time
        }
        ...
        if (updateMode != SKIP || forceUpate) updateItemAndCheck(item, itemRoot, itemName, getUpdateSchema(factory), record)
