...
class DevClassNameResolver implements ClassNameResolver {
    ...
    public String resolveClassname(String className) {
        if ('Item' == className) {
            return 'org.cristalise.dev.dsl.item.DevItem'
        }
        else if ('Agent' == className) {
            return 'org.cristalise.dev.dsl.item.DevAgent'
        }
        else if ('devDependency' == className || 'dependency' == className) {
            return 'org.cristalise.dev.dsl.item.DevDependency'
        }
        else if ('Module' == className) {
            return 'org.cristalise.dev.dsl.module.DevModule'
        }
        else {
