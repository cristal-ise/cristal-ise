...
Script('InstantiateAgent', 0) {
    ...
    script('groovy', "src/main/module/org/cristalise/dev/script/InstantiateAgent.groovy")
}
...
Script('LocalObjectDefCreator', 0) {
    ...
    input('job', 'org.cristalise.kernel.entity.Job')
    output('errors', 'org.cristalise.kernel.scripting.ErrorInfo')
    script('groovy', "src/main/module/org/cristalise/dev/script/LocalObjectDefCreator.groovy")
}
...
Script('New', 0) {
    ...
    input('job', 'org.cristalise.kernel.entity.Job')
    output('errors', 'org.cristalise.kernel.scripting.ErrorInfo')
    script('groovy', "src/main/module/org/cristalise/dev/script/New.groovy")
}
